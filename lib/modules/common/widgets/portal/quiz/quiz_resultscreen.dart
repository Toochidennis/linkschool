...
class _QuizResultsScreenState extends State<QuizResultsScreen> {
  ...
  List<Student> get students => widget.students; // ✅ use injected students
  ...
  void _markQuestion(int questionIndex, String status) {
    setState(() {
      students[currentStudentIndex].attempts[questionIndex] = QuizAttempt(
        questionNumber: students[currentStudentIndex]
            .attempts[questionIndex]
            .questionNumber,
        questionText:
            students[currentStudentIndex].attempts[questionIndex].questionText,
        userAnswer:
            students[currentStudentIndex].attempts[questionIndex].userAnswer,
        correctAnswer:
            students[currentStudentIndex].attempts[questionIndex].correctAnswer,
        marks: students[currentStudentIndex].attempts[questionIndex].marks,
        status: status,
        userAnswerImageUrl: students[currentStudentIndex]
            .attempts[questionIndex]
            .userAnswerImageUrl,
        correctAnswerImageUrl: students[currentStudentIndex]
            .attempts[questionIndex]
              ...
              children: [
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          Text(
                            '${_getTotalPossibleScore()}/${_calculateScore()}',
                            style: const TextStyle(
                              fontSize: 18,
                              fontWeight: FontWeight.bold,
                              color: AppColors.paymentTxtColor1,
                ...
                Padding(
                  ...
                  child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        ...List.generate(student.attempts.length, (index) {
                          return Padding(
                            padding: const EdgeInsets.only(bottom: 16.0),
                            child: _buildQuestionCard(
                                student.attempts[index], index),
                          );
                        }),
                      ]),
                )
               ...
               : const Text(
                ...
                Flexible(
                  child: Text(
                    ...
                    style: TextStyle(
                      fontSize: 14,
                      color: attempt.userAnswer.isEmpty
                          ? Colors.grey
                          : Colors.black54,
                      fontWeight: FontWeight.w500,
                    ),
              ...
              Row(
                ...
                children: [
                  Container(
                    ...
                    child: TextFormField(
                      initialValue:
                          (attempt.customMarks ?? attempt.marks).toString(),
