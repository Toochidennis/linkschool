...
class CourseRegistrationScreen extends StatefulWidget {
  ...
  const CourseRegistrationScreen(
      {super.key, required this.studentName, required this.coursesRegistered});
...
class _CourseRegistrationScreenState extends State<CourseRegistrationScreen> {
  ...
  void initState() {
    ...
    subjectColors = List.generate(subjects.length,
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Visibility(
                        visible:
                            isAnySubjectSelected(), // Show only if at least one subject is selected
