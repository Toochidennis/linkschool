        ...
        child: Column(
          children: [
            const TabBar(
              ...
              labelColor: AppColors.paymentTxtColor1,
            ...
            Expanded(
              child: Consumer<AccountProvider>(
                builder: (context, provider, child) {
                  ...
                  final incomeAccounts = provider.allAccounts.where((acc) => acc.accountType == 0).toList();
                  final expenditureAccounts = provider.allAccounts.where((acc) => acc.accountType == 1).toList();
                  return TabBarView(
                    children: [
                      _buildAccountList(context, incomeAccounts, 'No income accounts available'),
                      _buildAccountList(context, expenditureAccounts, 'No expenditure accounts available'),
                    ],
                  );
                },
              ),
...
// // New file: modules/admin/payment/account_selection_screen.dart
// import 'package:flutter/material.dart';
// import 'package:linkschool/modules/common/app_colors.dart';
// import 'package:linkschool/modules/common/text_styles.dart';
// import 'package:linkschool/modules/model/admin/account_model.dart';
...
//                     return const Center(child: CircularProgressIndicator());
//                   }
//                   final incomeAccounts = provider.allAccounts.where((acc) => acc.accountType == 21).toList();
//                   final expenditureAccounts = provider.allAccounts.where((acc) => acc.accountType == 24).toList();
//                   return TabBarView(
//                     children: [
//                       _buildAccountList(context, incomeAccounts),
//                       _buildAccountList(context, expenditureAccounts),
//                     ],
//                   );
//                 },
//               ),
