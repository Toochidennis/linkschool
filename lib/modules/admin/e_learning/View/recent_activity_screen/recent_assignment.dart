...
class _RecentAssignmentState extends State<RecentAssignment> with SingleTickerProviderStateMixin {
  ...
  int? academicTerm;
  String? academicYear;
  AssessmentContentItem? assignmentData;
  bool isLoading = true;
  String? errorMessage;
              ...
              onSelected: (String result) {
                switch (result) {
                  case 'edit':
                        ...
                        builder: (context) => AdminAssignmentScreen(
                          ...
                          assignmentToEdit: Assignment(
                            ...
                            attachments: (assignmentData?.contentFiles ?? [])
                                ...
                                .toList(),
                            dueDate: assignmentData?.endDate != null
                                ? DateTime.parse(assignmentData!.endDate!)
                                : DateTime.now(),
                    ...
                    break;
                  case 'delete':
                    deleteAssignment(widget.itemId.toString());
                    break;
                }
              },
        ...
        setState(() {
          ...
          if (!_isEditing) {
            comments.add(Comment(
              ...
              contentTitle: assignmentData?.title ?? 'No Title',
              userId: creatorId,
              levelId: widget.levelId,
              courseId: widget.courseId,
              courseName: widget.courseName,
