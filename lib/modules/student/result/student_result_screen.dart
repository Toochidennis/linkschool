...
class _StudentResultScreenState extends State<StudentResultScreen> with TickerProviderStateMixin {
      ...
      return Column(
        ...
        children: [
          ...
          ...terms.map((termData) {
            ...
            final termKey = '${year}_${termData['term']}_${termData['termName']}';
  ...
  Widget _buildTermRow(String term, double percent, Color indicatorColor, {bool isHovered = false}) {
