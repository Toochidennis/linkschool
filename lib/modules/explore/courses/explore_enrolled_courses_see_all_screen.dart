...
class ExploreEnrolledCoursesSeeAllScreen extends StatefulWidget {
  final String categoryName;
  final Color categoryColor;
  final int? profileId;
  final List<CourseModel> courses;

  const ExploreEnrolledCoursesSeeAllScreen({
    super.key,
  ...
  @override
  State<ExploreEnrolledCoursesSeeAllScreen> createState() =>
      _ExploreEnrolledCoursesSeeAllScreenState();
}

class _ExploreEnrolledCoursesSeeAllScreenState
    extends State<ExploreEnrolledCoursesSeeAllScreen> {
  Future<void> _handleCourseTap(
    ...
    final courseCategoryId = course.programId ?? -1;
                ...
                children: [
                  ...
                  Wrap(
                    ...
                    children: [
                      ...
                      if (course.hasTrial)
                        _infoChip(course.trialLabel, Colors.orange),
                      if (course.lessonsTaken != null)
                        _infoChip(
                          '${course.lessonsTaken} lessons taken',
                          Colors.blueGrey,
                        ),
                    ],
                  ),
