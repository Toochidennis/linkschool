                  ...
                  child: Container(
                    ...
                    child: SizedBox(
                      ...
                      child: Builder(builder: (buttonContext) {
                        // compute vars for trial/payment logic
                        final trialType =
                                  ...
                                  if (widget.hasEnrolled == true) {
                                    ...
                                    final trialTypeLocal =
                                        (widget.course.trialType ?? '')
                                            .toLowerCase();
                                    final parsedExpiryLocal =
                                        widget.course.trialExpiryDate != null
                                            ? DateTime.tryParse(
                                                ...
                                                Navigator.push(
                                                  ...
                                                  MaterialPageRoute(
                                                    builder: (context) =>
                                                      ...
                                                      trialValue: widget.course.trialValue,
                                                      lessonsTaken: widget.course.lessonsTaken,
                                                      cohortCost: (double.parse(cohort.cost.replaceAll('₦', '').replaceAll(',', ''))).toInt(),
                                                    ),
                                                  ),
                                                );
                                                }
                                    ...
                                    if (!widget.course.isFree &&
                                        (widget.course.paymentStatus == null ||
