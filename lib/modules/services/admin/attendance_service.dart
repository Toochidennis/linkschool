...
class AttendanceService {
  ...
  Future<ApiResponse<List<AttendanceRecord>>> getAttendanceHistory({
    ...
    try {
      ...
      if (response.success && response.rawData != null) {
        final List<dynamic> attendanceRecordsData = response.rawData!['data'] ??
            []; // Changed from 'attendance_records' to 'data'
  ...
  Future<ApiResponse<AttendanceRecord>> getAttendanceDetails({
    ...
    try {
      ...
      if (response.success && response.rawData != null) {
        final attendanceRecordData = response
            .rawData!['data']; // Changed from 'attendance_records' to 'data'
        final AttendanceRecord attendanceRecord =
            AttendanceRecord.fromJson(attendanceRecordData);
