...
//       if (loginResponse == null) {
//         throw Exception('No login data found. Please login again.');
//       }

//       // final dbParam = loginResponse['db'] ?? loginResponse['_db'];
//       final dbParam = userBox.get('_db');

//       if (dbParam == null) {
//         throw Exception('Database parameter not found in login data.');
//       }
