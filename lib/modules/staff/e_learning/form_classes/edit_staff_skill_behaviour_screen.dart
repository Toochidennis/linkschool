...
//   //   if (skillsPayload['skills']!.isNotEmpty) {
//   //     final success = await provider.createSkillsAndBehaviours(
//   //       skillsPayload: skillsPayload,
//   //       classId: widget.classId,
//   //       levelId: widget.levelId,
...
//     final skillsPayload = {
//       'skills': <Map<String,
//           dynamic>>[], // Explicitly define as List<Map<String, dynamic>>
//       'year': widget.year,
//       'term': widget.term,
//       '_db': widget.db,
//     };
...
//         ScaffoldMessenger.of(context).showSnackBar(
//           const SnackBar(
//               content: Text('Skills and behaviors saved successfully')),
//         );
//       } else if (mounted) {
//         ScaffoldMessenger.of(context).showSnackBar(
//           SnackBar(content: Text('Failed to save: ${provider.errorMessage}')),
