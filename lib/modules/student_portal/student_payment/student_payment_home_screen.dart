...
import 'package:linkschool/modules/student_portal/student_payment/student_pay_now_screen.dart';
import 'package:linkschool/modules/student_portal/student_payment/student_reciept_dialog.dart';
...
class _StudentPaymentHomeScreenState extends State<StudentPaymentHomeScreen> {
  ...
  void _navigateToPayNowScreen() {
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (context) => StudentPayNowScreen(),
      ),
    );
  }
