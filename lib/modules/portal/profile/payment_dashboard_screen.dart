...
class _PaymentDashboardScreenState extends State<PaymentDashboardScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    PreferredSize customAppBar = PreferredSize(
      preferredSize: const Size.fromHeight(kToolbarHeight + 16), // Increased height
      child: AppBar(
        systemOverlayStyle: SystemUiOverlayStyle.light, // This ensures status bar icons are visible
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        _buildRecordContainer('Generate Receipt', 'assets/icons/e_learning/receipt_icon.svg', Color.fromRGBO(45, 99, 255, 1)),
                        _buildRecordContainer('Expenditure', 'assets/icons/e_learning/expenditure_icon.svg', Color.fromRGBO(30, 136, 229, 1)),
                      ],
                    ),
                    const SizedBox(height: 24),
                    const Row(
                    ...
                    _buildTransactionItem('Sarah Williams', '09:00 AM, 2 days ago', -3500.00, 'grade 2'),
                  ],
                ),
              ),
            ),
 ...
 Widget _buildInfoContainer(String title, String value) {
    return Container(
      ...
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          Text(title, style: AppTextStyles.normal600(fontSize: 12, color: AppColors.assessmentColor1)),
          Row(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              const NairaSvgIcon(),
          ...
          child: Row(
            children: [
              Container(
                ...
                child: Center(
                  child: SvgPicture.asset('assets/icons/e_learning/receipt_list_icon.svg', width: 24, height: 24, color: Colors.white),
                ),
              ),
