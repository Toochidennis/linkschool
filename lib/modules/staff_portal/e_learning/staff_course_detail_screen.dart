...
class _StaffCourseDetailScreenState extends State<StaffCourseDetailScreen> {
  ...
  void _addQuestion(Question question) {
    setState(() {
      ...
      // Update the current syllabus with the new question title
        ...
        children: [
          ...
          Expanded(
            child: ListView(
              children: [
                _buildForumPost(
                  title: topics.isNotEmpty ? topics.first.name : "What is Punctuality?",
                  date: "25 June, 2015",
                  time: "08:52am",
                  isTopicPost: true,
                ),
          ...
          Row(
            children: [
              isTopicPost
                  ? Container(
                      padding: const EdgeInsets.all(8),
                      decoration: BoxDecoration(color: AppColors.eLearningBtnColor1,
                        borderRadius: BorderRadius.circular(8),
                      ),
                      child: const Icon(
                        Icons.description,
...
//             // Always show Assignment row if it exists
//             if (topics.isNotEmpty && topics.first.assignments.isNotEmpty)
//               InkWell(
//                 onTap: () {
//                   // Add navigation logic here if needed
...
//             // Always show Question row if it exists
//             if (topics.isNotEmpty && topics.first.questions.isNotEmpty)
//               InkWell(
//                 onTap: () {
//                   // Add navigation logic here if needed
